...
const createDestinationPriceTemplate = () => {
  return (
...
const createMenuElementTemplate = () => {
  return (
...
const createFilterElementTemplate = () => {
  return (
...
const createSortingElementTemplate = () => {
  return (
...
const createContentElementTemplate = () => {
  return (
    `        <ul class="trip-days">
    <li class="trip-days__item  day">
      ...
      <ul class="trip-events__list">
        ...
        <li class="trip-events__item">
          <div class="event">
            <div class="event__type">
              <img class="event__type-icon" width="42" height="42" src="img/icons/flight.png"
                alt="Event type icon">
            </div>
        ...
        <li class="trip-events__item">
          <div class="event">
            <div class="event__type">
              <img class="event__type-icon" width="42" height="42" src="img/icons/drive.png"
                alt="Event type icon">
            </div>
    ...
    <li class="trip-days__item  day">
      ...
      <ul class="trip-events__list">
        <li class="trip-events__item">
          <div class="event">
            <div class="event__type">
              <img class="event__type-icon" width="42" height="42" src="img/icons/sightseeing.png"
                alt="Event type icon">
            </div>
...
// render(contentElement, createLoadMoreButtonTemplate(), `beforeend`); в задании требуется добавить кнопку Load More, но не нашел ее в разметке
